...
export default function Players() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 animate-in fade-in zoom-in duration-500">
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map(i => (
            <Card key={i} className="bg-card/50 border-primary/20 h-48 animate-pulse cyber-grid" />
          ))}
        </div>
      ) : players?.length === 0 ? (
        <div className="text-center py-20 border border-primary/20 bg-card/30 cyber-grid">
