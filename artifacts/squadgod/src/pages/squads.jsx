...
function Squads() {
  ...
  return <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      {isLoading ? <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        </div> : squads?.length === 0 ? <div className="text-center py-20 border border-primary/20 bg-card/30 cyber-grid flex flex-col items-center justify-center">
          ...
          {squads?.map((squad) => <Link key={squad.id} href={`/squads/${squad.id}`}>
...
function CreateSquadDialog({ open, onOpenChange }) {
